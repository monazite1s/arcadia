        ...
        <div className="bg-background text-foreground flex min-h-screen flex-col items-center justify-center">
            <main className="flex flex-col items-center gap-8 text-center">
                <div className="space-y-4">
                    <h1 className="animate-pulse bg-gradient-to-r from-yellow-200 via-amber-300 to-yellow-400 bg-clip-text font-serif text-6xl font-bold tracking-tighter text-transparent sm:text-7xl">
                        ARCADIA
                    </h1>
