...
/**
 * 知识库文档目录组件
 * 复用 TableOfContents 逻辑,但使用无 Card 边框的文档风格
 */
export function DocTOC() {
    ...
    return (
        <div className="hide-scrollbar sticky top-24 max-h-[calc(100vh-6rem)] self-start overflow-y-auto">
            <div className="py-4">
                <h3 className="text-foreground mb-4 font-mono text-sm font-bold">目录</h3>
                <Stack gap="0.5rem">
